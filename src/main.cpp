...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitCurrency", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The NSA is on the moon... AND WERE COMING FOR A VISIT!";
        CTransaction txNew;
        txNew.nTime = 1412638207;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("ab9c76ee693c7f8040395acd8201eebcad24a12c904d6d22ad4c26c1b08ec796"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf8, 0xc7, 0xa1, 0xe9 };
